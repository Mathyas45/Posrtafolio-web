  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Por favor inténtalo de nuevo o envíame un correo directamente a mathyas.coronado@gmail.com",
        variant: "destructive"
      });
    } finally {
          ...
          <div className="space-y-6 sm:space-y-8 p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-secondary/20 to-background border border-border">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div>
                  <p className="text-xs sm:text-sm text-muted-foreground">Correo</p>
                  <a
                    href="mailto:mathyas.coronado@gmail.com"
                    className="text-sm sm:text-base font-medium hover:text-primary transition-colors"
                  >
                    mathyascoronado@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="pt-6 sm:pt-8">
              <h4 className="font-medium mb-3 sm:mb-4 text-xs sm:text-sm text-muted-foreground">Encuéntrame en</h4>
              <div className="flex gap-2 sm:gap-3">
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "www.linkedin.com/in/mathyas-alonzo-coronado-martinez-570491234",
                  },
                  {
                    icon: Twitter,
                    label: "Twitter",
                  ...
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/Mathyas45",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
                    url: "https://www.instagram.com/mathyascoronado/",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
            ...
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder="Hola, me encantaría colaborar en..."
                />
              </div>
