...
export const TestimonialSection = () => {
  ...
  const testimonials = [
    {
      id: 1,
      name: "Carlos Rivas Medina",
      role: "Dueño y odontologo en Clínica Dental Rivas",
      content: `Trabajar con Mathyas fue una experiencia excepcional. No solo entregó una solución backend robusta antes de lo programado, sino que también mantuvo una comunicación clara durante todo el proyecto. Es raro encontrar un desarrollador que entienda tanto la tecnología como el negocio.`,
      rating: 5,
    ...
    },
    {
      id: 2,
      name: "Bruno Pìneda",
      role: "Líder de Proyectos en SoftwarePro",
      content: `La arquitectura que diseñó Mathyas para nuestro sistema es impecable. Su conocimiento en Spring Boot y buenas prácticas de desarrollo aseguró que nuestro producto sea escalable y mantenible. Altamente recomendado.`,
      rating: 5,
    ...
    },
    {
      id: 3,
      name: "",
      role: "CEO en StartupLima",
      content: `Desde el diseño de la arquitectura hasta el despliegue, Mathyas manejó todo el stack con confianza y creatividad. El producto final es rápido, confiable y cumple con todos los requisitos de calidad. No dudaría en volver a trabajar con él.`,
      rating: 5,
        ...
        >
          <motion.div className="text-center" variants={itemVariants}>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Algunos testimonios de clientes satisfechos que han experimentado el impacto de mi trabajo.
            </motion.p>
          </motion.div>
