...
export const AboutSection = () => {
  ...
  const achievements = [
    { number: "10", label: "Proyectos", icon: <Briefcase className="h-5 w-5" />, suffix: "+" },
    { number: "3", label: "Años Exp.", icon: <Calendar className="h-5 w-5" />, suffix: "+" },
    { number: "100", label: "Compromiso", icon: <Target className="h-5 w-5" />, suffix: "%" },
    { number: "Maestría", label: "En curso", icon: <User className="h-5 w-5" />, suffix: "" }
  ];

  const techStack = [
    { category: "Backend", items: ["Java Spring Boot", "PHP Laravel", "Node.js", "APIs REST", "JWT"] },
    { category: "Frontend", items: ["Angular", "Vue.js", "React", "TypeScript", "Tailwind CSS"] },
    { category: "Móvil & DB", items: ["Kotlin Android", "PostgreSQL", "MySQL", "Docker", "Git"] }
  ];

  const features = ["Arquitectura limpia", "Código mantenible", "Buenas prácticas SOLID", "Metodologías ágiles", "Orientación a resultados", "Documentación clara"];

  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/mathyascoronado" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/mathyas-coronado" },
    { icon: <Twitter className="h-5 w-5" />, href: "#" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:mathyas.coronado@gmail.com" }
  ];
      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <div className="text-center mb-16 md:mb-20 px-2 sm:px-6">
          <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-2xl bg-primary/10 border border-primary/20 mb-6 transition-all duration-500 hover:bg-primary/15 hover:scale-105 group cursor-pointer">
            ...
            <span className="text-sm sm:text-base font-semibold text-primary tracking-wide">SOBRE MÍ</span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6">
            <span className="bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent">Transformando</span>
            <span className="block text-primary animate-pulse">Ideas en Realidad</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Construyendo experiencias digitales que combinan <span className="text-primary font-semibold">innovación</span>, <span className="text-primary font-semibold">rendimiento</span> y <span className="text-primary font-semibold">elegancia</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="xl:col-span-2 space-y-8">
            ...
            <div className="bg-card/50 border border-border rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:shadow-3xl hover:border-primary/40 hover:bg-card/60 relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/mathyas.jpg" alt="Mathyas Coronado" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Mathyas Coronado Martinez</h2>
                    <p className="text-primary text-base sm:text-lg font-semibold mb-3 sm:mb-4">Ingeniero de sistemas, desarrolador full stack</p>
                ...
                <div className="flex flex-col sm:flex-row border-b border-border mb-4 sm:mb-6">
                  {[{key: 'personal', label: 'Personal'}, {key: 'professional', label: 'Profesional'}, {key: 'approach', label: 'Enfoque'}].map(tab => (
                    <button
                      key={tab.key}
            ...
            <div className="bg-card/50 border border-border rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:shadow-3xl hover:border-primary/40 hover:bg-card/60">
              <h3 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                <Code className="h-4 sm:h-6 w-4 sm:w-6 text-primary" />Stack Tecnológico
              </h3>
          ...
          <div className="space-y-6 sm:space-y-8">
            {/* Work Together */}
            <div className="bg-card/50 border border-border rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:shadow-3xl hover:border-primary/40 hover:bg-card/60">
              <h3 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-6 text-center">Trabajemos Juntos</h3>
              <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-3 sm:space-y-0">
                <a href="#contact" className="flex-1 block w-full p-3 sm:p-4 bg-primary text-primary-foreground rounded-xl text-center font-semibold transition-all duration-300 hover:bg-primary/90 hover:scale-105 hover:shadow-lg group">
                  <div className="flex items-center justify-center gap-2 sm:gap-3"><User className="h-4 sm:h-5 w-4 sm:w-5 group-hover:scale-110 transition-transform duration-300" />Iniciar Proyecto</div>
                </a>
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-background/50 rounded-xl border border-border">
                <h4 className="font-semibold mb-2 text-center text-sm sm:text-base">Conexión Rápida</h4>
            ...
            <div className="bg-card/50 border border-border rounded-3xl p-4 sm:p-6 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:shadow-3xl hover:border-primary/40 hover:bg-card/60">
              <h3 className="text-base sm:text-xl font-bold mb-3 sm:mb-4 flex items-center gap-2"><Star className="h-4 sm:h-5 w-4 sm:w-5 text-primary" />¿Por qué Elegirme?</h3>
            ...
            <div className="bg-card/60 border border-border rounded-3xl p-4 sm:p-6 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:shadow-3xl hover:border-primary/40 hover:bg-card-70">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0 mb-2 sm:mb-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="font-semibold text-xs sm:text-sm">Disponible</span>
                </div>
