...
const skills = [
  // Backend - PHP primero como solicitaste
  { name: "PHP", level: 90, category: "backend", icon: "python" },
  { name: "Laravel", level: 90, category: "backend", icon: "python" },
  ...
  // Frontend
  { name: "Angular", level: 85, category: "frontend", icon: "typescript" },
  { name: "Vue.js", level: 70, category: "frontend", icon: "react" },
  ...
  { name: "Bootstrap", level: 90, category: "frontend", icon: "css" },

  // Móvil y Herramientas
  { name: "Kotlin", level: 75, category: "tools", icon: "java" },
  { name: "Android", level: 75, category: "tools", icon: "java" },
  { name: "Docker", level: 70, category: "tools", icon: "docker" },
  { name: "Git", level: 90, category: "tools", icon: "git" },
  { name: "GitHub", level: 90, category: "tools", icon: "github" },
  { name: "JWT", level: 85, category: "tools", icon: "cleark" },
  { name: "REST APIs", level: 90, category: "tools", icon: "graphql" },
  { name: "VS Code", level: 95, category: "tools", icon: "vscode" },
];

const categories = [
  { id: "all", label: "Todas", color: "bg-gradient-to-r from-purple-500 to-pink-500" },
  ...
  { id: "tools", label: "Herramientas", color: "bg-gradient-to-r from-orange-500 to-yellow-500" },
];
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Tecnologías que domino y mis niveles de competencia
          </p>
        </motion.div>
